...
nn.forward(all_images)
nn.Softmax_Loss.forward(nn.layerN.output, np.array(all_labels))
print(np.average(nn.Softmax_Loss.softmax.output[range(len(all_labels)), all_labels]))
nn.save()
